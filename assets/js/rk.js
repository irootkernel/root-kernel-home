...
(function () {
  ...
  function headingBadgeRects() {
    var sr = stage.getBoundingClientRect();
    return [].slice.call(stage.querySelectorAll('.head h2[data-a],.dt .body h2[data-a]'))
      .map(function (h2) {
        /* A1…An are generated by h2::before, so derive that painted box from the
  ...
  function layout() {
    ...
    measurePaints();
    /* H2 A1…An number boxes are visual objects even though CSS paints them as
       pseudo-elements; append their measured boxes as collision walls. */
    obs = obs.concat(headingBadgeRects());
    measureBounds();
  }
  function init() {
    injectFlightStatus();
