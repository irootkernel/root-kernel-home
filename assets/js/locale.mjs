...
const copy = {
  ko: {
    ...
    contactTitle:'다음 작업을<br>함께 이야기해요', contactIntro:'AI Agent 도입, 개발 도구, 제품과 협업에 관한 이야기를 기다립니다.',
  ...
  en: {
    ...
    contactTitle:'Let’s talk about<br>your next project', contactIntro:'Talk to us about AI agents, development tools, our products, or working together.',
