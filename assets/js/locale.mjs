...
const copy = {
  ko: {
    ...
    animate:'스크롤 애니메이션 보기 →', contactLink:'함께 이야기하기 →',
    ...
    rollback:'↶ 구현 보완 후 다시 테스트·리뷰', branchesRunning:'{n}개 분기 진행 중', branchesComplete:'필수 {n}개 완료',
    announcement:'{node}, 리비전 {revision}, {turn}번째 대화',
    contactTitle:'다음 작업을<br>함께 이야기해요', contactIntro:'홈페이지 제작, 사내 업무 도구, 맞춤형 소프트웨어 개발을 함께합니다. AI Agent 도입이나 기존 업무의 자동화도 이야기해 주세요.',
  ...
  en: {
    ...
    animate:'View the scroll animation →', contactLink:'Get in touch →',
    ...
    contactTitle:'Let’s talk about<br>your next project', contactIntro:'We design and build websites, internal tools, and custom software. We also help teams introduce AI Agents and automate existing workflows.',
